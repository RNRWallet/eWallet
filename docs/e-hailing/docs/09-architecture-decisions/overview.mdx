...
gantt
    ...
    Redis WebSockets       :done, data2, 2025-08-15, 30d
    Kafka                  :done, data3, 2025-09-01, 30d
    section Security & Identity
    Keycloak Identity      :done, security1, 2025-08-25, 45d
    section Communication
    WebSocket Realtime     :done, comm1, 2025-08-01, 30d
...
| [ADR-010](./adr-010-redis-websockets-scale) | Redis for WebSockets Scaling   | Accepted | Medium |
...
| ADR                                          | Title                                  | Status   | Impact |
|----------------------------------------------|----------------------------------------|----------|--------|
| [ADR-006](./adr-006-websockets-realtime)     | WebSockets for Real-time Communication | Accepted | Medium |
| [ADR-008](./adr-008-api-gateway)             | API Gateway                            | Accepted | High   |
